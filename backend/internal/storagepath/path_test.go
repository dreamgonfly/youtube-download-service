...
func TestNewPathFromURI(t *testing.T) {
	scheme, bucket, key, err := storagepath.ParseURI("gs://my-bucket/path/to/my/object.json")
	if err != nil {
...
func TestNewPathFromURIErr(t *testing.T) {
	scheme, bucket, key, err := storagepath.ParseURI("")
...
func TestNewPathFromKey(t *testing.T) {
	uri := storagepath.ComposeURI("gs", "my-bucket", "path/to/my/object.json")
